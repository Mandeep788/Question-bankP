...
@section('main-content')
    <form class="form1" action="{{ url('/userEdit') }}" enctype="multipart/form-data" method="POST" id="userEditForm">
        @csrf
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        @foreach ($users as $std)
                            <div class="d-flex" style="margin-top: 0px;">
                                ...
                                <input type="text" class="form-control first error" id="name" aria-describedby="nameHelp"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="form-control second error" id="phone_number" placeholder="Mobile Number"
