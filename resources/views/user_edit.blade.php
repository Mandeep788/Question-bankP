            ...
            <div class="col-7">
                ...
                <div class="mb-3">
                    ...
                    <div class="d-flex" style="margin-top: 0px;">
                        ...
                        <input type="text" class="form-control first error" id="name"
                ...
                <div class="mb-3 d-flex">
                    ...
                    <input type="text" class="form-control second error" id="phone_number"
                        placeholder="Mobile Number" name="phone_number" value="{{ $std->phone_number }}">
                </div>
                <div class="mb-3 d-flex">
                    <svg style="margin-right:-40px;margin-left:50px;margin-top:10px;"xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="form-check">
                        <input style="margin-left: 25px;" class="form-check-input error" type="radio" name="gender"
                    ...
                    <div class="form-check">
                        <input style="margin-left: 10px;" class="form-check-input error" type="radio" name="gender"
                            id="genderr" value="F" {{ $std->gender == 'F' ? 'checked' : '' }}>
                        <label class="form-check-label" for="flexRadioDefault1">
                            Female
                        </label>
                    </div>
                ...
                <div class="mb-3 d-flex">
                    ...
                    <input type="text" class="form-control second error" id="address" placeholder="Address"
                        name="address" id="address" value="{{ $std->address }}">
                </div>
                <div class="mb-3 d-flex">
                    <svg style="margin-right:-40px;margin-left:50px;margin-top:10px; width: 30px"
                        xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-laptop" viewBox="0 0 16 16">
                        <path
                            d="M13.5 3a.5.5 0 0 1 .5.5V11H2V3.5a.5.5 0 0 1 .5-.5h11zm-11-1A1.5 1.5 0 0 0 1 3.5V12h14V3.5A1.5 1.5 0 0 0 13.5 2h-11zM0 12.5h16a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5z" />
                    </svg>
                    <select name="userTechnology[]" id="userTechnology" placeholder="Enter your technologies"
                        class="form-control p-2 mx-5 border-0 selectpicker error" multiple data-live-search="true">
                ...
                <div class="mb-3 d-flex">
                    ...
                    <input type="text" class="form-control second error" id="last_company"
                ...
                <div class="mb-3 d-flex">
                    ...
                    <input type="text" class="form-control second error" id="current_company"
                        placeholder="Current Company" name="current_company" value="{{ $std->current_company }}">
                </div>
                <div class="mb-3 d-flex">
                    <svg style="margin-right:-40px;margin-left:50px;margin-top:10px;"
                        xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                    ...
                    <input type="text" class="form-control second error" id="designation"
                ...
                <div class="mb-3 d-flex">
                    ...
                    <input type="text" class="form-control second error" id="experience" placeholder="Experience"
