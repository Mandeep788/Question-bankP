...
@section('main-content')
    ...
    <form class="form1" action="{{ url('/user_edit') }}" enctype="multipart/form-data" method="POST" id="myform">
        @csrf
        <div class="container">
            <div class="fgt">
            ...
            <div class="row">
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input type="hidden" name="id" id="employeeId" value="{{$std->id}}">
                            ...
                            <div class="d-flex" style="margin-top: 50px;">
                                ...
                                <input type="text" class="error" id="nameId" aria-describedby="nameHelp"
                                    placeholder="Enter Your Name" name="name" value="{{ $std->name }}">
                            </div>
                    </div>
                    <div class="mb-3 d-flex">
                        ...
                        <input type="email" class="error" id="emailId" placeholder="Email" name="email"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="error" id="phoneNoId" placeholder="phone_number"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <div class="form-check">
                            <input style="margin-left: 25px;" class="error" type="radio" name="gender"
                                id="genderId" value="M" checked>
                            <label class="form-check-label" for="flexRadioDefault1">
                                Male
                            </label>
                        </div>
                        <div class="form-check">
                            <input style="margin-left: 10px;" class="error" type="radio" name="gender"
                                id="genderId" value="F">
                            <label class="form-check-label" for="flexRadioDefault1">
                                Female
                            </label>
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="error" id="addressId" placeholder="Address"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="error" id="lastCompanyId"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="error" id="currentComapny"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="error" id="designationId" placeholder="Designation"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="text" class="error" id="experienceId" placeholder="Experience"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <input type="file" name="image" class="error" id="image"
                            value="{{ $std->image }}">
                    </div>
